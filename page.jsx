...
export default function LoveWebsite() {
  ...
  const questions = [
    ...
    {
      question: "🌙 When do I love going for walks?",
      answers: [
    ...
    {
      question: "❄️ What season do I love the most?",
      answers: [
    ...
    {
      question: "❤️ Who do I love the most?",
      answers: [
  ...
  const handleAnswer = (correct) => {
    ...
    if (correct) {
      ...
      setFeedback("Correct 😌✨ You really know me...");
    } else {
      setFeedback("Wrong 😏 But I still adore you...");
    }
    ...
    <div style={styles.container}>
      ...
      {page === "proposal" && (
        <div style={styles.card}>
          <h1 style={styles.glowTitle}>Hey Handsome 💖</h1>
          <p style={styles.text}>
            Tonight isn’t just a game… it’s a little reminder of how much you mean to me.
          </p>
      ...
      {page === "ending" && (
        <div style={styles.card}>
          <h1 style={styles.glowTitle}>Final Score: {score}/4 💕</h1>
          ...
          <p style={styles.loveLetter}>
            ...
            fully explain. You are not just someone I love — you are someone I
            admire, respect, and feel endlessly grateful for. No matter what the
            score says, I choose you. Every day. In every lifetime. 💖
          </p>
